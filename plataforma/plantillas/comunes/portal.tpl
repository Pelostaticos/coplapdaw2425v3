{* Pantilla Smarty para portal público de la plataforma correplayas
...
<head>
    ...
    <link rel="stylesheet" href="estilos/portal.css">
...
<body>
        ...
        <!-- Sección para hablar de la plataforma correplayas -->
         <section id="correplayas">
            <!-- Artículo que describe el proyecto de la plataforma correplayas -->
             <article>
                ...
                <a href="#observatorios" class="boton">Nuestros observatorios</a>
            </article>
        </section>
         ...
         <section id="observatorios">
            ...
            <article>
                ...
                <img src="imagenes/observatorios.jpg" alt="Foto del observatorio Torre del Puerco" />
         ...
         <section id="voluntariado">
            ...
            <article>
                ...
                <h2 class="subtitulo">¿Cómo puedes ayudar?</h2>
                ...
                <img src="imagenes/voluntariado.jpg" alt="Foto del correlimos común con triactilo al fondo" />
    ...
    <script src="javascript/correplayas.js"></script>
</body>
</html>