{* Plantilla Smarty para vista del listado de jornadas de la plataforma correplayas
...
{include file="comunes/header.tpl" titulo="Listado de jornadas" usuario=$usuario}
    <!-- Contenidos de la página para el listado de jornadas de la plataforma correplayas -->
    <main id="inicio">        
            ...
            <!-- Artículo que describe el proyecto de la plataforma correplayas -->
             <article>
                ...
                <div class="contenido-gestor">
                    ...
                    <!-- Tabla que representa al listado de jornadas -->
