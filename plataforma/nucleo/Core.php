...
class Core {
    ...
    public static function enviarEmail($smarty, $mail) {
        ...
        // Si es modo "DemostraciónW" esta habilitado NO permito el envío de formularios de contacto.
        if (IS_DEMO_MODE) {

            // El modo "Demostración " esta HABILITADO entonces:
            // Lanzo excepción para indicar al usuario de que no está permitido el envío de formularios de contacto en la plataforma.
            throw new AppException('El modo de demostración no permite el envío de formularios de contacto');

        }
        else {

            // De lo contrario, se encuentra DESHABILITADO el modo "Demostración":
