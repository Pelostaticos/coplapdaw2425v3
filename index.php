...
<body>
    ...
    <header>
        ...
        <a href="#inicio"><img src="plataforma/imagenes/correplayas.png" alt="logotipo del portal web correplayas"/></a>
        <!-- Zona de navegación -->
        <nav>
            <!-- Menú del sitio web -->
            <ul>
    ...
    <main id="inicio">
        <!-- Sección para hablar de la plataforma correplayas -->
         <section id="correplayas">
            <!-- Artículo que describe el proyecto de la plataforma correplayas -->
             <article>
                ...
                <a href="#observatorios"><span class="boton">Nuestros observatorios</span></a>
            </article>
        </section>
         ...
         <section id="observatorios">
            ...
            <article>
                <h1 class="titulo">Los observatorios</h1>
                <h2 class="subtitulo">¿Qué aportan al proyecto?</h2>
         ...
         <section id="voluntariado">
            ...
            <article>
                <h1 class="titulo">El voluntariado</h1>
                <h2 class="titulo">¿Cómo puedes ayudar?</h2>
